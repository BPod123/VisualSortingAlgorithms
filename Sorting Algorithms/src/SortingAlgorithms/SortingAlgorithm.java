...
public abstract class SortingAlgorithm implements Runnable {
    ...
    private int numPermits; // The number of permits that a sorting algorithm needs, higher number if it is more inclined to mess up in the UI
    ...
    public SortingAlgorithm(int numPermits){
