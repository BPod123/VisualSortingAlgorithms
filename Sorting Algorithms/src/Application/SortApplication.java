...
public class SortApplication extends Application {
    ...
    public static int numDataPoints = 10;
    public static double paneHeight = 300;
    public static double paneWidth = 300;
    public static long waitTime = 00;
    public static SortApplication app;
